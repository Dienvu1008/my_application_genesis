...
import 'package:my_application_genesis/screen_settings/auth/cache.dart';
...
class AuthenticationRepository {
  ...
  AuthenticationRepository({
    ...
    //FacebookSignIn? facebookSignIn,
        ...
        //_facebookSignIn = facebookSignIn ?? FacebookSignIn.standard();
  ...
  Future<void> logInWithFacebook() async {
    ...
    try {
      ...
      if (isWeb) {
        ...
        //final facebookUser = await _facebookSignIn.signIn();
        //final facebookAuth = await facebookUser!.authentication;
        credential = firebase_auth.FacebookAuthProvider.credential(result.accessToken.toString()
